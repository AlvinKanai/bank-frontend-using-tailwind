...
const Hero = () => {
    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
        ...
        {/* Hero section text area section */}
        <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
            {/* Discount banner on hero section */}
            <div className='flex flex-row py-[6px] items-center px-4 bg-discount-gradient rounded-[10px] mb-2'>
